 ...
 * @author USER
 */
public class NFJequiti extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("AvonQuiti - Cadastro Nota Fiscal Jequiti");
        setLocation(new java.awt.Point(500, 100));

        jLabel1.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        jLabel1.setText("CADASTRO NOTA FISCAL JEQUITI");
...
lucro=(pvenda-pcusto)*quant;
 try {
            ...
            new NFController().salvarJ(codigo,codp,nomep,quant,pcusto,pvenda,lucro);
...
setVisible(false);// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NFJequiti.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
